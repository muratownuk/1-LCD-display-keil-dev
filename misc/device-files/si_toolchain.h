 ...
 * uint8_t myVar;
 *
 * SI_SEGMENT_VARIABLE(myVar, uint8_t, SI_SEG_XDATA);
 * ~~~~~~~~
 *****************************************************************************/
 ...
 *
 * SI_VARIABLE_SEGMENT_POINTER(pVar, uint8_t, SI_SEG_XDATA);
 * ~~~~~~~~
 *****************************************************************************/
 ...
 *
 * SI_SEGMENT_VARIABLE_SEGMENT_POINTER(pVar, uint8_t, SI_SEG_XDATA, SI_SEG_DATA);
 * ~~~~~~~~
 *****************************************************************************/
 ...
 *
 * SI_SEGMENT_POINTER(pVar, uint8_t, SI_SEG_DATA);
 * ~~~~~~~~
 *****************************************************************************/
 ...
 * uint8_t myMemVar;
 *
 * SI_LOCATED_VARIABLE_NO_INIT(myMemVar, uint8_t, SI_SEG_DATA, 0x4000);
 * ~~~~~~~~
 *****************************************************************************/
